                    ...
                    <tbody>
                        @foreach($recours as $recour)
                            <tr>
                                ...
                                {{-- <td><a href="{{ url('teacher/marks_register') }}" target="_blank" class="btn btn-info  ">
                                    <i class="fas fa-pencil-alt"></i>
                                    Traité
                                </a></td> --}}
                                <td>
                                    <a href="{{ url('teacher/marks_register?class_id=' . $recour->class->id . '&exam_id=' . $recour->exam_id) }}" target="_blank" class="btn btn-info">
                                        <i class="fas fa-pencil-alt"></i>
                                        Traité
                                    </a>
                                </td>
