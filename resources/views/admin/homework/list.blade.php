      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
              <a href="{{ url('admin/homework/homework/add') }}" class="btn btn-info"><i class="fa-solid fa-file-circle-plus"></i> Add New Homework</a>
          </div>
        </div>
      </div>
    </section>
                        ...
                        <tr>
                          ...
                          <td style="min-width: 200px;">
                              @if(!empty($value->getDocument()))
                                {{-- <a href="{{ $value->getDocument() }}" class="download-btn btn-primary" download="" ><i id="downloadBtn" class="fas fa-download"></i> Download</a> --}}
                          ...
                          <td style="min-width: 500px;">
                             ...
                             <a href="{{ url('admin/homework/homework/submitted/'.$value->id) }}" class="btn btn-success"><i class="fas fa-download"></i> Submitted Homework</a>
                          </td>
                        </tr>
                      @empty
                      <tr>
