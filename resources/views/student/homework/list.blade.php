                  ...
                  <tbody>
                    @forelse($getRecord as $value)
                        <tr>
                          ...
                          <td style="min-width: 200px;">{{ date('d-m-Y', strtotime($value->homework_date)) }}</td>
                          <td style="min-width: 200px;">{{ date('d-m-Y', strtotime($value->submission_date)) }}</td>
                          ...
                          <td style="min-width: 200px;">{{ date('d-m-Y', strtotime($value->created_at)) }}</td>
