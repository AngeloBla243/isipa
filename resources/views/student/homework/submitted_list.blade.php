                  ...
                  <tbody>
                    @forelse($getRecord as $value)
                        <tr>
                          ...
                          <td style="min-width: 200px;">{{ date('d-m-Y', strtotime($value->getHomework->homework_date)) }}</td>
                          <td style="min-width: 200px;">{{ date('d-m-Y', strtotime($value->getHomework->submission_date)) }}</td>
